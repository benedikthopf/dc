...
import timm
from slot_attention import SlotAttention, SoftPositionEmbed
from sklearn.decomposition import PCA
from slate_transformer import TransformerDecoder
...
class DINOSAUR(nn.Module):
    ...
    def forward(self, x, *args, **kwargs):
        ...
        slots, masks = self.slot_attention(x, *args, **kwargs)
